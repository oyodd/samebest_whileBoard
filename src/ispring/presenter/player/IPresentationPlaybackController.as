 ...
 * @langversion 3.0
 * @playerversion Flash 10.1
 * @productversion iSpring&nbsp;Pro 6.1
...
public interface IPresentationPlaybackController extends IEventDispatcher
{
	...
	/**
	 * Returns the next slide index taking hidden slides and custom slide shows
	 * into account.
	 *
	...
	/**
	 * Returns the previous slide index taking hidden slides and custom slide shows
	 * into account.
	 * 
